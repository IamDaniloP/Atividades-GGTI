...
import com.danilo.atividade08.implementation.usecases.RegisterPersonUseCaseImpl;
import com.danilo.atividade08.main.controllers.erros.ErrorResponse;
...
public class RegisterPersonController {
    ...
    public ResponseEntity<ErrorResponse> create(@RequestBody @Valid CreatePersonDto personDto, BindingResult bindingResult) {
        ...
        var person = new Person(personDto.name, personDto.lastName(), personDto.email(), personDto.age());
